...
//LZYNOTE:鐎瑰啫婀弸鍕拷锟界姾绻栨禍娑楃鐟楄法娈戦弮璺猴拷锟芥瑧鏁ら惃鍕Ц娑擄拷锟芥稉鐚篹ad閺傝纭舵禒搴″従鐏忎浇顥栭惃鍒塷rdNetFileReader缁鑵戠拠缁樻殶閹诡噯绱濇担鐘插讲娴犮儲濡告潻娆庨嚋WordNetFileReader閹肩偞鍣﹂敍宀�鏁ょ�瑰啰娈慠ead閺傝纭堕敍灞惧灗閼板懓鍤滃鍗炵杽閻滈绔存稉顏囶嚢閺佺増宓侀惃鍕拷锟芥槒绶敍灞藉晙閸愭瑤绔存稉顏呯�柅鐘插毐閺佽埇锟斤拷锟斤拷
public class Synset {
